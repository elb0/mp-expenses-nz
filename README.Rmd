...
So I totally shouldn't be playing with this data. I SHOULD be editting a paper for my thesis. But come on, this is pretty interesting! If you would like to play with any of this, all my files are on [GitHub](https://github.com/elb0/mp-expenses-nz).
...
I was a bit surprised that a lot of ministers ("Honourable") had no expenses, and ministers had lower expenses overall. Are the MPs that get ministerial positions more likely to live in Wellington? Or at least not represent the regions, from which travel costs might be higher? Turns out honour is cheap!
...
data = read_csv("Data/2018-08-16_members-expenses.csv")
data_prev = read_csv("Data/2018-05-10_members-expenses.csv")
